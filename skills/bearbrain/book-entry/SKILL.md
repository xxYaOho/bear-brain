...
| 栏目 | 适用场景 | 正文名称 |
| --- | --- | --- |
| `book/reference` | 来源明确、偏回查 | 正文（原文） |
| `book/knowledge` | 已提炼、可复用 | 正文（内容） |
| `book/guide` | 规范、流程、指南 | 正文（规范） |
| `book/idea` | 未归属的想法 | 正文（想法） |
...
2. 判断内容成熟度，选择合适栏目
3. 按栏目模板创建笔记
4. 填写 Summary、Take、正文
5. 如需升级为其他栏目，创建新笔记，保留原笔记作为来源
